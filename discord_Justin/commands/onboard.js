...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    async execute(interaction) {
      ...
      const newMemberId = interaction.options.getUser('user').id;
      // console.log('interaction: ', interaction.member)
      console.log('interaction: ', interaction.locale)
      ...
      const result = await interaction.member.guild.channels.create(
        "onboarding " + interaction.options.getUser('user').username,
        {
      ...
      const welcomeMessage = `Hey <@${newMemberId}>!`;
      let messageId = "";
      ...
      const messageMaker = async (message) => {
        return interaction.guild.channels.fetch(channelId).then(async (channel) => {
      ...
      client.on("interactionCreate", async (interaction) => {
        ...
        // console.log('customId: ', interaction.member.guild.presences.clientStatus)
        // console.log('customId: ', interaction.member.presence.clientStatus)
